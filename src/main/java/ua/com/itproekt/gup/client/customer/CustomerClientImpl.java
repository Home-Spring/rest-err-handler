...
import ua.com.itproekt.gup.client.BaseWebServiceClientImpl;
import ua.com.itproekt.gup.client.MyRequestCallback;
import ua.com.itproekt.gup.client.MyResponseExtractor;
...
public class CustomerClientImpl extends BaseWebServiceClientImpl implements CustomerClient {
    ...
    public RestCustomer saveCustomer(RestCustomer customer) {
        ...
        MyResponseExtractor responseExtractor = new MyResponseExtractor(RestCustomer.class, restTemplate.getMessageConverters());
